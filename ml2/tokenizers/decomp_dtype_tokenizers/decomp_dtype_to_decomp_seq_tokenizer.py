"""Tokenizer that encodes a decomposed data type into a decomposed sequence encoding"""
...
from ..to_decomp_seq_tokenizer import DecompSeqEncoding, ToDecompSeqTokenizer
from ..to_seq_tokenizer import SeqEncoding
...
@register_type
class DecompDTypeToDecompSeqTokenizer(ToDecompSeqTokenizer[S, T], Generic[S, T]):
    def encode(self, data: T, **kwargs) -> DecompSeqEncoding:
        ...
        return DecompSeqEncoding(seq_encs=encs)
