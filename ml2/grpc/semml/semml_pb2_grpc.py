...
class SemmlStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SynthesizeStream = channel.stream_stream(
                '/Semml/SynthesizeStream',
                request_serializer=ml2_dot_grpc_dot_ltl_dot_ltl__syn__pb2.LTLSynProblem.SerializeToString,
                response_deserializer=ml2_dot_grpc_dot_ltl_dot_ltl__syn__pb2.LTLSynSolution.FromString,
                )


class SemmlServicer(object):
    """SemML: Enhancing Automata-Theoretic LTL Synthesis with Machine Learning
    """
...
def add_SemmlServicer_to_server(servicer, server):
    rpc_method_handlers = {
...
class Semml(object):
    ...
    def Setup(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Semml/Setup',
    ...
    def Identify(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Semml/Identify',
    ...
    def Synthesize(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Semml/Synthesize',
    ...
    def SynthesizeStream(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/Semml/SynthesizeStream',
            ml2_dot_grpc_dot_ltl_dot_ltl__syn__pb2.LTLSynProblem.SerializeToString,
            ml2_dot_grpc_dot_ltl_dot_ltl__syn__pb2.LTLSynSolution.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
