...
class NuSMVStub(object):
    """The NuSMV model checker. https://nusmv.fbk.eu
    """
    ...
    def __init__(self, channel):
        ...
        self.ModelCheckStream = channel.stream_stream(
                '/NuSMV/ModelCheckStream',
                request_serializer=ml2_dot_grpc_dot_ltl_dot_ltl__mc__pb2.LTLMCProblem.SerializeToString,
                response_deserializer=ml2_dot_grpc_dot_ltl_dot_ltl__mc__pb2.LTLMCSolution.FromString,
                )


class NuSMVServicer(object):
    """The NuSMV model checker. https://nusmv.fbk.eu
    """
...
def add_NuSMVServicer_to_server(servicer, server):
    rpc_method_handlers = {
...
class NuSMV(object):
    ...
    def Setup(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/NuSMV/Setup',
    ...
    def Identify(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/NuSMV/Identify',
    ...
    def ModelCheck(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/NuSMV/ModelCheck',
    ...
    def ModelCheckStream(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/NuSMV/ModelCheckStream',
            ml2_dot_grpc_dot_ltl_dot_ltl__mc__pb2.LTLMCProblem.SerializeToString,
            ml2_dot_grpc_dot_ltl_dot_ltl__mc__pb2.LTLMCSolution.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
