...
class TLSFFileString(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["tlsf", b"tlsf"]) -> None: ...
...
class ConvertTLSFToSpecRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["tlsf", b"tlsf"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["parameters", b"parameters", "tlsf", b"tlsf"]) -> None: ...
...
class ConvertTLSFToSpecResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_specification", b"_specification", "_time", b"_time", "specification", b"specification", "time", b"time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_specification", b"_specification", "_time", b"_time", "error", b"error", "specification", b"specification", "time", b"time", "tool", b"tool"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_specification", b"_specification"]) -> typing.Literal["specification"] | None: ...
    @typing.overload
