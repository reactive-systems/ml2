...
class GenericLTLModelCheckerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Identify = channel.unary_unary(
                '/GenericLTLModelChecker/Identify',
        ...
        self.ModelCheck = channel.unary_unary(
                '/GenericLTLModelChecker/ModelCheck',
        ...
        self.ModelCheckStream = channel.stream_stream(
                '/GenericLTLModelChecker/ModelCheckStream',
                request_serializer=ml2_dot_grpc_dot_ltl_dot_ltl__mc__pb2.LTLMCProblem.SerializeToString,
                response_deserializer=ml2_dot_grpc_dot_ltl_dot_ltl__mc__pb2.LTLMCSolution.FromString,
                )


class GenericLTLModelCheckerServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_GenericLTLModelCheckerServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'GenericLTLModelChecker', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class GenericLTLModelChecker(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def Setup(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/GenericLTLModelChecker/Setup',
    ...
    def Identify(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/GenericLTLModelChecker/Identify',
    ...
    def ModelCheck(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/GenericLTLModelChecker/ModelCheck',
    ...
    def ModelCheckStream(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/GenericLTLModelChecker/ModelCheckStream',
            ml2_dot_grpc_dot_ltl_dot_ltl__mc__pb2.LTLMCProblem.SerializeToString,
            ml2_dot_grpc_dot_ltl_dot_ltl__mc__pb2.LTLMCSolution.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
