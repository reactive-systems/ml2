...
class LTLMCProblem(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["circuit", b"circuit", "decomp_specification", b"decomp_specification", "formula_specification", b"formula_specification", "mealy_machine", b"mealy_machine", "specification", b"specification", "system", b"system"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["circuit", b"circuit", "decomp_specification", b"decomp_specification", "formula_specification", b"formula_specification", "mealy_machine", b"mealy_machine", "parameters", b"parameters", "realizable", b"realizable", "specification", b"specification", "system", b"system"]) -> None: ...
    @typing.overload
...
class LTLMCSolution(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_counterexample", b"_counterexample", "_time", b"_time", "counterexample", b"counterexample", "time", b"time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_counterexample", b"_counterexample", "_time", b"_time", "counterexample", b"counterexample", "detailed_status", b"detailed_status", "status", b"status", "time", b"time", "tool", b"tool"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_counterexample", b"_counterexample"]) -> typing.Literal["counterexample"] | None: ...
    @typing.overload
