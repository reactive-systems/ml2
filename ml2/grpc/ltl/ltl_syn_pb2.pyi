...
class LTLSynProblem(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["decomp_specification", b"decomp_specification", "formula_specification", b"formula_specification", "specification", b"specification"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["decomp_specification", b"decomp_specification", "formula_specification", b"formula_specification", "parameters", b"parameters", "specification", b"specification", "system_format", b"system_format"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["specification", b"specification"]) -> typing.Literal["decomp_specification", "formula_specification"] | None: ...
...
class LTLSynSolution(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_realizable", b"_realizable", "_time", b"_time", "circuit", b"circuit", "mealy_machine", b"mealy_machine", "realizable", b"realizable", "system", b"system", "time", b"time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_realizable", b"_realizable", "_time", b"_time", "circuit", b"circuit", "detailed_status", b"detailed_status", "mealy_machine", b"mealy_machine", "realizable", b"realizable", "status", b"status", "system", b"system", "time", b"time", "tool", b"tool"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_realizable", b"_realizable"]) -> typing.Literal["realizable"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_time", b"_time"]) -> typing.Literal["time"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["system", b"system"]) -> typing.Literal["circuit", "mealy_machine"] | None: ...
...
class NeuralLTLSynSolution(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_model_checking_solution", b"_model_checking_solution", "_time", b"_time", "model_checking_solution", b"model_checking_solution", "synthesis_solution", b"synthesis_solution", "time", b"time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_model_checking_solution", b"_model_checking_solution", "_time", b"_time", "model_checking_solution", b"model_checking_solution", "synthesis_solution", b"synthesis_solution", "time", b"time", "tool", b"tool"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_model_checking_solution", b"_model_checking_solution"]) -> typing.Literal["model_checking_solution"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_time", b"_time"]) -> typing.Literal["time"] | None: ...
...
class NeuralLTLSynSolutionSpecPair(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["decomp_specification", b"decomp_specification", "formula_specification", b"formula_specification", "solution", b"solution", "specification", b"specification"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["decomp_specification", b"decomp_specification", "formula_specification", b"formula_specification", "solution", b"solution", "specification", b"specification"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["specification", b"specification"]) -> typing.Literal["decomp_specification", "formula_specification"] | None: ...
