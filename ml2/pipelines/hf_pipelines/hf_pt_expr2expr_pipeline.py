"""HuggingFace PyTorch expression to expression pipeline"""
...
@register_type
class HFPTExpr2ExprPipeline(HFPTText2TextPipeline[I, T], Generic[I, T]):
    def __init__(
        self,
        input_notation: str = "infix",
        target_notation: str = "infix",
        ...
        **kwargs,
        ...
        self.target_notation = target_notation
        target_kwargs = target_kwargs if target_kwargs is not None else {}
        target_kwargs["notation"] = target_notation
        super().__init__(input_kwargs=input_kwargs, target_kwargs=target_kwargs, **kwargs)
