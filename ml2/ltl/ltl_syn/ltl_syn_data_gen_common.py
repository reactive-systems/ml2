...
from ... import aiger
from .ltl_syn_data import sample_to_csv_row
...
def add_ltl_syn_data_gen_args(parser):
    ...
    parser.add_argument('--num-ands-plus-latches',
                        ...
                        help=('number of AND gates plus latches in AIGER'
                              'circuit'))
    parser.add_argument('--num-assumptions',
                        action=argparse_min_max(),
                        nargs='*',
                        default=(0, None),
                        metavar=('min', 'max'),
    ...
    parser.add_argument('--upload',
                        action='store_true',
                        help='upload generated data to GCP storage bucket')
...
def csv_dataset_writer(queue, folder_path, num_samples, train_frac, val_frac,
    ...
    for split in ['train', 'val', 'test']:
        ...
        file_writer.writerow([
            'assumptions', 'guarantees', 'inputs', 'outputs', 'realizable',
            'circuit'
        ])
