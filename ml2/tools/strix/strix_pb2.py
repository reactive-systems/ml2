...
_STRIXPROBLEM = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='specification', full_name='StrixProblem.specification', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='minimize_aiger', full_name='StrixProblem.minimize_aiger', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='minimize_mealy', full_name='StrixProblem.minimize_mealy', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='threads', full_name='StrixProblem.threads', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='timeout', full_name='StrixProblem.timeout', index=4,
...
_STRIXSOLUTION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='StrixSolution.status', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='system', full_name='StrixSolution.system', index=1,
...
_STRIXPROBLEM.fields_by_name['specification'].message_type = ml2_dot_tools_dot_protos_dot_ltl__pb2._LTLSPECIFICATION
...
StrixProblem = _reflection.GeneratedProtocolMessageType('StrixProblem', (_message.Message,), {
...
StrixSolution = _reflection.GeneratedProtocolMessageType('StrixSolution', (_message.Message,), {
