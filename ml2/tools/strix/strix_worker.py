...
def strix_worker(server,
    ...
    while ray.get(server.has_unsolved_problems.remote()):
        ...
        for problem in problems:
            solution = strix_wrapper_dict(problem, minimize_aiger,
...
def strix_worker_fn(ds_server,
    ...
    while ray.get(ds_server.has_unsolved_problems.remote()):
        ...
        for problem_dict in problems:
            ...
            status, circuit = strix.synthesize(problem, minimize_aiger,
                                               minimize_mealy, threads, timeout)
