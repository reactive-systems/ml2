...
_BOSYPROBLEM = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='specification', full_name='BoSyProblem.specification', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='optimize', full_name='BoSyProblem.optimize', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='timeout', full_name='BoSyProblem.timeout', index=2,
...
_BOSYSOLUTION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='BoSySolution.status', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='system', full_name='BoSySolution.system', index=1,
...
_BOSYPROBLEM.fields_by_name['specification'].message_type = ml2_dot_tools_dot_protos_dot_ltl__pb2._LTLSPECIFICATION
...
BoSyProblem = _reflection.GeneratedProtocolMessageType('BoSyProblem', (_message.Message,), {
...
BoSySolution = _reflection.GeneratedProtocolMessageType('BoSySolution', (_message.Message,), {
