FROM --platform=amd64 tensorflow/tensorflow:latest-gpu

# #Google Cloud SDK

# ENV CLOUDSDK_PYTHON=/usr/bin/python3

RUN curl -fsSL -o google-cloud-cli.tar.gz  https://dl.google.com/dl/cloudsdk/channels/rapid/downloads/google-cloud-cli-458.0.1-linux-x86_64.tar.gz && \
